...
public class LibraryArticlesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        articleAdapter.setArticles(homeArticles);
        ...
        library_articles_recycler.addOnItemTouchListener(new RecyclerViewTouchListener(requireContext(), library_articles_recycler, new RecyclerViewTouchListener.RecyclerViewClickListener() {
            ...
            public void onClick(View v, int position) {
                ...
                bundle.putString("id", homeArticles.get(position).getArticleId());
        ...
        search_category.setAdapter(categories_adapter);
        ...
        view.findViewById(R.id.library_search_button).setOnClickListener(v -> {
            if (search.getEditText().getText().toString().trim().isEmpty()) {
                ...
                getArticlesByTitle(search.getEditText().getText().toString().trim(), BlogCategoriesString.get(search_category.getSelectedItemPosition()));
            }
        });
